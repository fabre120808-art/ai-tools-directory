  ...
  return (
    <div className="space-y-6 py-6">
      <section className="border-b border-[var(--line)] pb-6">
        <h1 className="text-2xl font-bold tracking-[-0.03em]">새로운 AI 도구를 제보해주세요</h1>
        <p className="mt-2 text-sm text-[var(--muted)]">
          아직 등록되지 않은 AI 도구가 있다면 알려주세요. 검토 후 목록에 추가하겠습니다.
        </p>
      </section>
        ...
        <form className="grid gap-5">
          ...
          <label className="grid gap-2">
            ...
            <textarea
              ...
              placeholder="이 도구가 어떤 작업에 좋고, 누구에게 잘 맞는지 적어주세요"
            />
          </label>
