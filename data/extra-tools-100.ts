...
export const extraTools100: Tool[] = [
  ...makeGroup(
    ...
    "{name}은(는) 아이디어 정리와 초기 방향 설정을 빠르게 도와주는 서비스입니다.",
  ...
  ...makeGroup(
    ...
    "{name}은(는) 검색 주제 발굴과 리서치 중심의 콘텐츠 기획에 특화된 도구입니다.",
  ...
  ...makeGroup(
    ...
    "{name}은(는) 짧은 카피와 마케팅 문구를 빠르게 만드는 데 강한 서비스입니다.",
  ...
  ...makeGroup(
    ...
    "{name}은(는) 장문 작성과 문장 다듬기, 초안 정리에 강한 도구입니다.",
  ...
  ...makeGroup(
    ...
    "{name}은(는) 비주얼 생성과 크리에이티브 시안 제작을 빠르게 도와주는 서비스입니다.",
  ...
  ...makeGroup(
    ...
    "{name}은(는) 썸네일, 배너, 카드뉴스처럼 가벼운 디자인 작업을 빠르게 처리해주는 도구입니다.",
  ...
  ...makeGroup(
    ...
    "{name}은(는) 영상 기획, 대본 작성, AI 영상 제작 흐름을 빠르게 도와주는 서비스입니다.",
  ...
  ...makeGroup(
    ...
    "{name}은(는) 자막 생성과 번역, 전사 중심의 미디어 작업을 돕는 서비스입니다.",
  ...
  ...makeGroup(
    ...
    "{name}은(는) TTS와 보이스오버, 음성 출력 경험 제작에 강한 서비스입니다.",
  ...
  ...makeGroup(
    ...
    "{name}은(는) 문서와 회의, 리서치 자료를 빠르게 정리해주는 요약 중심 서비스입니다.",
